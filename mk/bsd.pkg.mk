...
.if !empty(SUBPACKAGES)
.  for _spkg_ in ${SUBPACKAGES}
PKG_SYSCONFSUBDIR.${_spkg_}?=	# empty
.if empty(PKG_SYSCONFSUBDIR.${_spkg_})
DFLT_PKG_SYSCONFDIR.${_spkg_}:=	${PKG_SYSCONFBASEDIR}
.else
DFLT_PKG_SYSCONFDIR.${_spkg_}:=	${PKG_SYSCONFBASEDIR}/${PKG_SYSCONFSUBDIR.${_spkg_}}
.endif
PKG_SYSCONFDIR.${_spkg_}=		${DFLT_PKG_SYSCONFDIR.${_spkg_}}
.if defined(PKG_SYSCONFDIR.${PKG_SYSCONFVAR})
PKG_SYSCONFDIR.${_spkg_}=	${PKG_SYSCONFDIR.${PKG_SYSCONFVAR}}
PKG_SYSCONFBASEDIR=		${PKG_SYSCONFDIR.${PKG_SYSCONFVAR}}
.endif
PKG_SYSCONFDIR_PERMS.${_spkg_}?=	${REAL_ROOT_USER} ${REAL_ROOT_GROUP} 755
.  endfor
.else # !SUBPACKAGES
