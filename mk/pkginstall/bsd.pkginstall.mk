...
SETUID_ROOT_PERMS.${_spkg_}?=	${REAL_ROOT_USER} ${REAL_ROOT_GROUP} 4511
SETGID_GAMES_PERMS.${_spkg_}?=	${GAMES_USER} ${GAMES_GROUP} ${GAMEMODE}
GAMEDATA_PERMS.${_spkg_}?=	${GAMES_USER} ${GAMES_GROUP} ${GAMEDATAMODE}
GAMEDIR_PERMS.${_spkg_}?=	${GAMES_USER} ${GAMES_GROUP} ${GAMEDIRMODE}
