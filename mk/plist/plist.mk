...
#
#	For SUBPACKAGES PLIST_TYPE must always be static.
#
...
#	PLIST.common_end
#
#	For SUBPACKAGES this is per-subpackage, PLIST_SRC.<spkg>.
#	By default, its value is constructed from the PLIST.<spkg>.* files
#	within the package directory, in the following order (if the files are
#	present):
#
#	PLIST.<spkg>.common
#	PLIST.<spkg>.${OPSYS}			(e.g., PLIST.<spkg>.NetBSD)
#	PLIST.<spkg>.${MACHINE_ARCH}		(e.g,, PLIST.<spkg>.macppc)
#	PLIST.<spkg>.${OPSYS}-${MACHINE_ARCH}	(e.g., PLIST.<spkg>.NetBSD-macppc)
#	PLIST.<spkg>
#	PLIST.<spkg>.common_end
#
...
#
#	For SUBPACKAGES this is per-subpackage, GENERATE_PLIST.<spkg> and
#	output of commands is appended to the contents of ${PLIST_SRC.<spkg>}.
#
...
#
#	For SUBPACKAGES this is per-subpackage, GENERATE_PLIST.<spkg> and
#	output of the commands is appended to the contents of
#	${PLIST_SRC.<spkg>}
#
.if !empty(SUBPACKAGES)
.  for _spkg_ in ${SUBPACKAGES}
